...
std::istream& LibRendererDll::operator>>(std::istream& s_in, Model& model_out)
{
	// model name size
...
std::ostream & LibRendererDll::operator<<(std::ostream & output_out, const VertexElement & ve_in)
{
...
std::istream & LibRendererDll::operator>>(std::istream & s_in, VertexElement & ve_out)
{
...
std::istream& LibRendererDll::operator>>(std::istream& s_in, Model::Mesh& mesh_out)
{
...
std::ostream& LibRendererDll::operator<<(std::ostream& output_out, const Model::Material& mat_in)
{
	// material name size
...
std::istream& LibRendererDll::operator>>(std::istream& s_in, Model::Material& mat_out)
{
	// material name size
...
std::ostream& LibRendererDll::operator<<(std::ostream& output_out, const Model::TextureDesc& tex_in)
{
	// file path size
...
std::istream& LibRendererDll::operator>>(std::istream& s_in, Model::TextureDesc& tex_out)
{
	// file path size
