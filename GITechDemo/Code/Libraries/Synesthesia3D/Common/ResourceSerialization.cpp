...
std::ostream& Synesthesia3D::operator<<(std::ostream& output_out, const Model& model_in)
{
	// model name size
...
std::istream& Synesthesia3D::operator>>(std::istream& s_in, Model& model_out)
{
	// model name size
...
std::ostream & Synesthesia3D::operator<<(std::ostream & output_out, const VertexElement & ve_in)
{
...
std::istream & Synesthesia3D::operator>>(std::istream & s_in, VertexElement & ve_out)
{
...
std::ostream &Synesthesia3D::operator<<(std::ostream &output_out, VertexFormat &vf_in)
{
...
std::istream &Synesthesia3D::operator>>(std::istream &s_in, VertexFormat &vf_out)
{
...
std::ostream& Synesthesia3D::operator<<(std::ostream& output_out, VertexBuffer& vb_in)
{
...
std::istream& Synesthesia3D::operator>>(std::istream& s_in, VertexBuffer& vb_out)
{
	s_in >> *(Buffer*)&vb_out;
...
std::ostream& Synesthesia3D::operator<<(std::ostream& output_out, IndexBuffer& ib_in)
{
...
std::istream& Synesthesia3D::operator>>(std::istream& s_in, IndexBuffer& ib_out)
{
	s_in >> *(Buffer*)&ib_out;
...
std::ostream& Synesthesia3D::operator<<(std::ostream& output_out, Buffer& buf_in)
{
...
std::istream& Synesthesia3D::operator>>(std::istream& s_in, Buffer& buf_out)
{
...
std::ostream& Synesthesia3D::operator<<(std::ostream& output_out, const Model::Mesh& mesh_in)
{
	// mesh name size
...
std::istream& Synesthesia3D::operator>>(std::istream& s_in, Model::Mesh& mesh_out)
{
...
std::ostream& Synesthesia3D::operator<<(std::ostream& output_out, const Model::Material& mat_in)
{
	// material name size
...
std::istream& Synesthesia3D::operator>>(std::istream& s_in, Model::Material& mat_out)
{
	// material name size
...
std::ostream& Synesthesia3D::operator<<(std::ostream& output_out, const Model::TextureDesc& tex_in)
{
	// file path size
...
std::istream& Synesthesia3D::operator>>(std::istream& s_in, Model::TextureDesc& tex_out)
{
	// file path size
...
std::ostream& Synesthesia3D::operator<<(std::ostream& output_out, Texture& tex_in)
{
...
std::istream& Synesthesia3D::operator>>(std::istream& s_in, Texture& tex_out)
{
	s_in >> *(Buffer*)&tex_out;
