                       ...
                       FT_Bool    header_only )
  {
    ...
    else if ( loader->n_contours == -1 )
    {
      ...
      if ( face->doblend )
      {
        ...
        // GITechDemo: warning C4701: potentially uninitialized local variable 'outline' used
        ...
        // GITechDemo: warning C4244: '=' : conversion from 'FT_UInt' to 'short', possible loss of data
