...
// Some handy defines   //
//////////////////////////
#define CREATE_MODEL_HANDLE(NAME) extern VirtualMuseumApp::Model NAME
#define CREATE_TEXTURE_HANDLE(NAME) extern VirtualMuseumApp::Texture NAME
#define CREATE_SHADER_HANDLE(NAME) extern VirtualMuseumApp::Shader NAME
#define CREATE_SHADER_CONSTANT_HANDLE(NAME, TYPE) extern VirtualMuseumApp::ShaderConstantTemplate<TYPE> NAME;
#define CREATE_RENDER_TARGET_HANDLE(NAME) extern VirtualMuseumApp::RenderTarget NAME
#define SWAP_RENDER_TARGET_HANDLES(RT1, RT2) { VirtualMuseumApp::RenderTarget* const TEMP = RT1; RT1 = RT2; RT2 = TEMP; }
