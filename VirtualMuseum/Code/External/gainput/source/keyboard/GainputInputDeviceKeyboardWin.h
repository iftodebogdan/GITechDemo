...
public:
	...
	void HandleMessage(const MSG& msg)
	{
		...
		if (msg.message == WM_CHAR)
		{
			...
			// GITechDemo: warning C4244 'initializing' : conversion from 'const WPARAM' to 'const int', possible loss of data
		...
		case WM_SYSKEYDOWN:
			pressed = true;
			// GITechDemo: warning C4244 '=' : conversion from 'const WPARAM' to 'unsigned int', possible loss of data
			winKey = (unsigned int)msg.wParam;
			break;
		case WM_KEYUP:
		case WM_SYSKEYUP:
			pressed = false;
